...
<head>
    ...
    <title>Reception des courriers</title>
</head>
...
<body class="background-image" background="images/background-image.jpg">
    <div class="shadow-lg rounded card-img-overlay border border-primary carde" style="width: 50rem;">
        ...
        <div class="card-img-overlay">
            ...
            <h1 class="titre4">Reception des courriers</h1>
            <div class="formulaire">
                <div class="form-group row">
                    <label for="example-date-input" class="col-2 col-form-label datenvoi">Date reception </label>
                    <div class="col-10">
                        <input class="form-control date-envoi" type="date" id="example-date-input">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-email-input" class="col-2 col-form-label destinataire1">Expeditaire :</label>
                    <div class="col-10">
                        <input class="form-control email3" type="email" placeholder="xxx@xxx.com">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label naturela1">Nature :</label>
                    <div class="col-10">
                        <input class="form-control nature" type="text">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="formFile" class="form-label piece1">Pièces reçues :</label>
                ...
                <label class="modrecep">Mode reception :</label>
