...
<body class="background-image" background="images/background-image.jpg">
    ...
    <img src="images/transparent.png" class="card-img" alt="transparent">
        <div class="card-img-overlay">
            ...
            <label for=" nom"></label>
                    <input class="form-control name" type="text" name="nom" id="nom" placeholder="Entrez votre nom">
                    <label for="prenom"></label>
                    <input class="form-control firstname" type="text" name="prenom" id="prenom" placeholder="Entrez votre prénom">
                    <label for="email"></label>
                    <input class="form-control email2" type="email" name="email" id="email"
                        placeholder="Entrez votre adresse mail">
                    <label for="password"></label>
                    <input class="form-control mdp2" type="password" name="password" id="password" placeholder="Entrez votre mot de passe">
